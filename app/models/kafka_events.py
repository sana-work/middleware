...
EVENT_NORMALIZATION_MAP: Dict[str, str] = {
    ...
    "TOOL_RESPONSE_EVENT": "tool_completed",
    "TOOL_CALL_EVENT": "tool_started",
...
EXECUTION_STATUS_MAP: Dict[str, str] = {
    ...
    "TOOL_CALL_EVENT": "in_progress",
    "TOOL_RESPONSE_EVENT": "in_progress",
...
EVENT_SUMMARY_MAP: Dict[str, str] = {
    ...
    "TOOL_CALL_EVENT": "Tool invoked: {tool_name}",
    "TOOL_RESPONSE_EVENT": "Tool output received: {tool_name}",
